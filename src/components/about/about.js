    ...
    return (
      <section role="complementary" id="about">
        <h1 className="about-title">Driven by Curiosity, Mastery, Technology, Sound, and Design</h1>
          ...
          My experience with music, art, food, travel, and most importantly people, has provided me with skills to be a successful developer. I am innately compelled to learn and share new things, whether its the latest JavaScript frameworks, new cooking techniques or yet another musical instrument. I enjoy challenges that make me think outside the box and require creative solutions as well as surrounding myself with diverse people who bring their own passion to the table.
          </p>
      </section>
    );
  }
